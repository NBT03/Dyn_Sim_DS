...
def run_bidirectional_rrt():
    ...
    for trial in range(num_trials):
        # Đặt vật cản ở vị trí cao nhất ngay từ đầu
        ...
        if grasp_success:
            ...
            if path_conf is None:
                ...
                # In ra các vị trí end-effector (nếu cần)
                for joint_state in path_conf:
                ...
                # Thực thi đường đi
                print("Bắt đầu di chuyển theo đường đi cao nhất...")
                ...
                print("Hoàn thành di chuyển. Thả đối tượng.")
                env.open_gripper()
                env.step_simulation(num_steps=5)
                env.close_gripper()
                
                # Di chuyển ngược lại
                print("Di chuyển ngược lại về vị trí ban đầu...")
    ...
    print(f"Thành công: {passed}/{num_trials}")
